...
The CLI prints baseline totals, scenario totals, and the swing for Candidate A in votes and percentage points. The web app at `http://localhost:8000/` displays the same results in a dashboard.
